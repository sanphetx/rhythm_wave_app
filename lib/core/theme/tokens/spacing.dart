...
final class WaveSpacing extends ThemeExtension<WaveSpacing> {
  const WaveSpacing({
    required this.x6s,
    required this.x5s,
    required this.x4s,
  ...
  static const spacing = WaveSpacing(
    x6s: 2,
    x5s: 4,
    x4s: 8,
    x3s: 12,
  ...
  @override
  WaveSpacing lerp(ThemeExtension<WaveSpacing>? other, double t) {
    if (other is! WaveSpacing) {
      return this;
    }
